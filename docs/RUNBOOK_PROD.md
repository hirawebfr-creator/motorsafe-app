...
- [ ] **Prisma Accelerate**
  - [ ] `DATABASE_URL` configuré (URL pooler Prisma Accelerate: `prisma://...`)
  - [ ] `DIRECT_DATABASE_URL` configuré (URL directe PostgreSQL: `postgresql://...`)
...
DIRECT_DATABASE_URL="postgresql://user:password@host:5432/motorsafe"
