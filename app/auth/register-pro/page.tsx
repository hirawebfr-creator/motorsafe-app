    ...
    <main className="mx-auto flex min-h-screen w-full max-w-6xl items-center justify-center px-6 py-16">
      <Card className="w-full max-w-2xl">
        <div className="grid gap-3">
          <p className="text-xs uppercase tracking-[0.3em] text-[var(--muted)]">Demande compte pro</p>
          <h1 className="text-3xl font-semibold">Rejoindre MotorSafe</h1>
          <p className="text-sm text-[var(--muted)]">
            Votre demande est verifiee par l'administration avant activation.
          </p>
        </div>
