  ...
  return (
    <div className="grid gap-8">
      <div>
        ...
        <h1 className="mt-3 text-3xl font-semibold">Identite du garage</h1>
        <p className="mt-2 max-w-2xl text-sm text-[var(--muted)]">
          Centralisez les informations legales et la configuration de conformite pour votre atelier.
        </p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card className="grid gap-3">
          <div className="flex items-center justify-between">
            ...
            <Badge variant="accent">{user.role === "ADMIN" ? "Admin" : "Garage"}</Badge>
          </div>
        ...
        <Card className="grid gap-3">
          <div>
            ...
            <h2 className="mt-2 text-xl font-semibold">Assurance et responsabilite</h2>
          </div>
          <div className="grid gap-2 text-sm text-[var(--muted)]">
            <p>Traceabilite: chaque intervention conserve un hash immuable.</p>
            <p>Preuve technique: le payload fige les parametres critiques.</p>
            <p>Historique revisions: chaque modification est horodatee.</p>
            <p>Responsabilite pro: les dossiers PDF servent de preuves d'atelier.</p>
          </div>
