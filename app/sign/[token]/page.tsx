...
export default function SignPage() {
  ...
  const handleSign = async () => {
    if (!hasRead || !signerName.trim() || signerName.trim().length < 2) {
      return;
    }
            ...
            <div className="p-6">
              ...
              <label className="flex items-start gap-3 mb-4 cursor-pointer">
                ...
                <span className="text-sm text-slate-600">
                  J'ai lu et consulté le document. Je comprends que cette signature électronique a valeur d'engagement.
                </span>
              </label>
              ...
              <button
                onClick={handleSign}
                disabled={!hasRead || signerName.trim().length < 2 || signing}
